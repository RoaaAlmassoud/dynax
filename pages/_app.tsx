  ...
  const getData = async () => {
    ...
    if (response.data) {
      ...
      if (namesResponse.data) {
        const facilityResponse = await AxiosApi.call({}, `facilities`, "get", "");
    ...
    return (
      <Layout displayHeader={displayHeader} displayName={displayName}>
        {loading? null:<Component {...pageProps} names={names} facilityData={facility}/>}
      </Layout>
    );
}
